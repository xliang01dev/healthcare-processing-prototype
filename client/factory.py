...
PATIENTS: list[dict] = [
    {
        ...
        "procedures": ["99213 - Office visit, established patient, low complexity", "93000 - Electrocardiogram, complete"],
        "medications": ["Metformin 1000mg twice daily", "Lisinopril 10mg daily", "Atorvastatin 20mg daily", "Aspirin 81mg daily"],
    ...
    },
    {
        ...
        "encounter_status": "discharged",
        "procedures": ["99214 - Office visit, established patient, moderate complexity", "80053 - Comprehensive metabolic panel"],
        "medications": ["Levothyroxine 75mcg daily", "Amlodipine 5mg daily", "Simvastatin 20mg daily"],
    ...
    },
    {
        ...
        "pcp_npi": "3456789012",
        "member_id": "MEM-3KP9LF2QR45",
        "eligibility_status": "active",
        "network_status": "in-network",
        "authorization_required": True,
        "authorization_status": "pending",
        "facility_name": "Texas Medical Center",
        "encounter_status": "active",
        "procedures": ["99215 - Office visit, established patient, high complexity", "92004 - Comprehensive eye exam"],
        "medications": ["Metformin 500mg twice daily", "Glipizide 5mg daily", "Omeprazole 20mg daily", "Furosemide 40mg daily"],
        "allergies": ["NSAIDs (GI upset)", "Codeine (respiratory depression)"],
    },
    {
        ...
        "encounter_status": "discharged",
        "procedures": ["99213 - Office visit, established patient, low complexity"],
        "medications": ["Warfarin 5mg daily", "Metoprolol 50mg twice daily", "Prednisone 5mg daily"],
        "allergies": ["Aspirin (bleeding risk)", "Lisinopril (cough)"],
    },
    {
        ...
        "encounter_status": "discharged",
        "procedures": ["99214 - Office visit, established patient, moderate complexity", "71046 - Chest X-ray, 2 views"],
        "medications": ["Albuterol inhaler 2 puffs 4x daily", "Tiotropium 18mcg daily", "Fluticasone/Salmeterol inhaler"],
    ...
    },
    {
        ...
        "encounter_status": "discharged",
        "procedures": ["99215 - Office visit, established patient, high complexity", "93000 - Electrocardiogram, complete"],
        "medications": ["Donepezil 10mg daily", "Sertraline 50mg daily", "Calcium carbonate 500mg twice daily", "Vitamin D 1000 IU daily"],
        "allergies": ["Morphine (nausea)", "Doxycycline (photosensitivity)"],
    },
]
...
def build_medicare(patient: dict) -> tuple[str, MedicareEvent]:
    ...
    return "medicare", MedicareEvent(
        ...
        # Coverage information from patient profile
        member_id=patient["member_id"],
        eligibility_status=patient["eligibility_status"],
        network_status=patient["network_status"],
        authorization_required=patient["authorization_required"],
        authorization_status=patient["authorization_status"],
    )
...
def build_hospital(patient: dict) -> tuple[str, HospitalEvent]:
    ...
    return "hospital", HospitalEvent(
        ...
        clinical_notes=f"""Patient {patient['first_name']} {patient['last_name']} admitted {admission.strftime('%m/%d/%Y')}.
Received treatment at {patient['facility_name']}.
Discharged {discharge.strftime('%m/%d/%Y')} in stable condition.""",
    )
