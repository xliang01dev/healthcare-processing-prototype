...
GRANT USAGE ON SCHEMA mpi, reconciliation, timeline, llm TO hs_writer, hs_reader;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA llm GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO hs_writer;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA llm GRANT SELECT ON TABLES TO hs_reader;
